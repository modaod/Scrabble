...
// import { A_ASCII } from '@app/constant';
...
export class TargetValidationService {
    ...
    checkTargetCompletion(target: Target, command: string): boolean {
        ...
        // const direction = command.split(' ')[1][2];
        // const caseOfPlacement: Vec2 = { x: parseInt(command.split(' ')[1][1], 10), y: command.split(' ')[1][0].charCodeAt(0) - A_ASCII };
        switch (target.id) {
            case TARGET_ID0:
