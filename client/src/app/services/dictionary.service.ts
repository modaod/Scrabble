...
export class DictionaryService {
    ...
    // url: string = environment.serverUrl + '/dictionary/';
    ...
    download(name: string) {
        ...
        this.http.get(/* environment.serverUrl*/ this.url + '/assets/' + name).subscribe((dataReceived) => {
    ...
    async reset() {
        return new Promise((resolve, reject) => {
            this.http.delete(this.url + 'all').subscribe(
                (response) => {
                    resolve(response);
                },
                (error) => {
